...
// Low stock: available ≤ 10% of purchased total
...
export default function InventoryPage() {
  ...
  // Unique pick zones and categories from loaded inventory
    ...
    <div>
      ...
      {tab==="Inventory"&&(
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          ...
          <Table loading={loading}
            cols={["SKU","Product","Category","Subcategory","Pick Zone","Type","Location","Purchased","Sold","Available","Cost","Stock Value","Status"]}
            rows={filtered}
            renderRow={r=>{
              ...
              return(<>
                ...
                <Td>
                  <Badge color={out?"red":low?"amber":"green"}>
      ...
      {tab==="Return Inventory"&&(
        <div style={{display:"flex",flexDirection:"column",gap:16}}>
          ...
          <Table loading={loading}
            cols={["SKU","Product","Type","Category","Location","Purchased","Sold","Available","Cost","Stock Value","Status"]}
            rows={filteredReturn}
            renderRow={r=>{
